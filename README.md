...
<p align="center" style="margin:16px 0 6px 0;">
  <!-- WEBSITE -->
  <a href="onderbalta.com" title="onderbalta.com">
  ...
  <a href="https://www.linkedin.com/in/onderbalta/" title="LinkedIn">
    <svg width="176" height="44" viewBox="0 0 176 44" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="LinkedIn">
      ...
      <g transform="translate(14,12)" fill="#22FF66">
        ...
        <path d="M9,8c3,0,4.9,1.8,4.9,5v7h-3.6v-6.3c0-1.8-0.9-2.9-2.5-2.9c-1.6,0-2.8,1.2-2.8,2.9V20H1.4V8h3.4v1.7
                 c0.9-1.2,2.2-1.7,4.2-1.7Z"/>
      </g>
      <text x="62" y="28" font-family="ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace" font-size="14" fill="#22FF66">LinkedIn</text>
    </svg>
  </a>
  &nbsp;&nbsp;
  <!-- ITCH.IO -->
  <a href="https://gousk.itch.io/" title="itch.io">
    <svg width="158" height="44" viewBox="0 0 158 44" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="itch.io">
      ...
      <text x="62" y="28" font-family="ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace" font-size="14" fill="#22FF66">itch.io</text>
    </svg>
  </a>
</p>
